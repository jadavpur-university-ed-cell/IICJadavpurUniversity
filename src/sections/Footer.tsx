      ...
      <div className="max-w-content mx-auto px-6 pt-20 pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-[280px]" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              ...
              Created and Maintained by JU E-Cell.
            </p>
          </div>
          ...
          {/* Col 3 - Integrations */}
          <div>
            <p className="text-sm font-medium text-pure-white mb-4">Quick Links</p>
            <ul className="space-y-2">
              {[
          ...
          {/* Col 4 - Newsletter */}
          <div>
            <p className="text-sm font-medium text-pure-white mb-4">Stay Updated</p>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 min-w-0 px-4 py-2.5 rounded-lg text-sm text-pure-white outline-none transition-colors duration-200 focus:border-electric-blue"
                style={{
                  background: '#2A2A2E',
              ...
              />
              <button
                className="px-5 py-2.5 rounded-lg text-sm font-medium bg-soft-lime text-midnight hover:brightness-110 transition-all duration-200 shrink-0"
              >
                Subscribe
              </button>
            </div>
        ...
        >
          <p className="text-xs" style={{ color: 'rgba(255, 255, 255, 0.3)' }}>
            © 2026 Jadavpur University. All Rights Reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            {/* LinkedIn */}
            <a href="#" className="transition-colors duration-200" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
